...
public class Protocol {
	...
	public static final int IDEXIST=111;//로그인 할시에 아이디가 db에 존재하는지 확인
	public static final int CHECKPWD=112;//로그인 할시에 아이디가 db에 존재하는지 확인	//로그인 후 WaitRoom으로 창 생성
	//public static final int
	
	//게임관련
	
	public static final int CHECK=10;		//로그인 후 WaitRoom으로 창 생성
	...
	public static final int WAITROOMENTER=220;	//클라이언트가 웨이팅룸으로 갔을 때
	public static final int CLIENTLIST=221;//전체 클라이언트 명수
	public static final int ROOMLIST=222;//방갯수
	public static final int WAITCLIENTNUM=223;//게임하고있는 클라이언트의 명수
