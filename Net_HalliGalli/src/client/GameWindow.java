...
public class GameWindow extends JPanel {
	...
	public GameWindow() {
		...
		tmpSeeF = new ImageIcon("cardimg/Banana_2.jpg");
		Image tmp3 = tmpSeeF.getImage();
		Image tmp4 = tmp3.getScaledInstance(50, 70, java.awt.Image.SCALE_DEFAULT);
		seeF = new ImageIcon(tmp4);
	...
	public void setProfile(String name) {
		...
		// Image tmp2 = tmp.getScaledInstance(200, 235,
